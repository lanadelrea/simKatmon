...
def get_results(
    ...
    for amplicon in amplicon_ids:
        ...
        #primer_info_formatted = primer_info_formatted.append(primer_df) edited by ALR
        primer_info_formatted = pd.concat([primer_info_formatted, primer_df], ignore_index=True)
...
def parse_arguments(system_args):
    ...
    parser.add_argument("-q", "--frequency-amplicons", metavar="FILE", dest="frequency_amplicons", default=None, help="Path to file with amplicon id and frequency")
